...
begin
  ...
  begin
    ...
    begin
      EnviaMensagem('O sistema já possui um cadastro com esse RG!', 'Informação', mtInformation, [mbOK]);
      Exit;
    end;
  end;
    ...
    case AcaoTela of
      'I':
        begin
          ...
          SQL.Add(')');
          ExecSQL;
          EnviaMensagem('Usuário cadastrado com sucesso!', 'Informação', mtInformation, [mbOK]);
