...
begin
  ...
  begin
    if (MessageBox(Handle, 'O cliente atual será removido!' + #13#13 + 'Gostaria de remover os produtos que foram adicionados?', 'Atenção', MB_ICONQUESTION + MB_YESNO)) = IDYES then
    begin
      edCodCC.Clear;
      edNomeCC.Clear;
...
begin
  ...
  begin
    ...
    begin
      EnviaMensagem('Este produto já foi adicionado!' + #13#13 + 'Dê um Duplo Clique sobre o mesmo para Editar!', 'Informação', mtInformation, [mbOk]);
      btnLimparP.Click;
