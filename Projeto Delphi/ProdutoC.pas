    ...
    case AcaoTela of
      'I':
        begin
          ...
          SQL.Add(')');
          ExecSQL;
          EnviaMensagem('Produto cadastrado com sucesso!','Informação',mtInformation,[mbOK]);

          yCodigo := GetCodigo('PRODUTO'); //retorna último registro para feedback no grid
        end;
      'E':
        begin
          Close;
          ...
          EnviaMensagem('As informações do produto foram alteradas!', 'Informação', mtInformation, [mbOK]);
        end;
    end;
  end;
  Close;
...
begin
  ...
  begin
    EnviaMensagem('Utilize apenas Letras.', 'Informação', mtInformation, [mbOK]);
    Key := #0;
  end
end;
...
begin
  ...
  begin
    EnviaMensagem('Utilize apenas Números.', 'Informação', mtInformation, [mbOK]);
    Key := #0;
  end;
end;
