object TCompra: TTCompra
  ...
  object Panel3: TPanel
    ...
    object lblPesquisa: TLabel
      ...
      Width = 333
      Height = 14
      Caption = 'Digite * e Tecle Enter ou selecione uma coluna da 1'#170' Tabela'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = 'Tahoma'
    ...
    object edPesquisaCompra: TEdit
      ...
      TabOrder = 0
      OnKeyPress = edPesquisaCompraKeyPress
    end
  ...
  object qCompra: TADOQuery
    Connection = TDMPrincipal.Conexao
    CursorType = ctStatic
    AfterScroll = qCompraAfterScroll
    Parameters = <>
    Left = 536
    Top = 152
  end
